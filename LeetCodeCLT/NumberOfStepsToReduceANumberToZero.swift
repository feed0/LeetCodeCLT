...
/// https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/submissions/2003266527/
...
struct NumberOfStepsToReduceANumberToZero {
    ...
    struct Solution {
        ...
        func numberOfSteps(_ num: Int) -> Int {
            ...
            while decreasingNum > 0 {
                ...
                if decreasingNum.isMultiple(of: 2) {
                    decreasingNum /= 2
                } else {
                    decreasingNum -= 1
                }
